...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of CocoaRouge
  #
  #                   * Markdown format.
  ...
  # s.authors      = { "Arik Devens" => "arik@danieltiger.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Arik Devens', 'other author'

  # Specify the location from where the source should be retrieved.
  #
  s.source       = { :git => "https://github.com/danieltiger/CocoaRouge.git", :tag => "v0.0.1" }
